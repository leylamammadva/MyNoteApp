...
import az.altacademy.androidgroup2.databinding.FragmentEditNoteBinding
...
class EditNoteFragment : Fragment(R.layout.fragment_edit_note), MenuProvider {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.editNoteTitle.setText(currentNote.notesTitle)
    ...
    override fun onCreateMenu(menu: Menu, menuInflater: MenuInflater) {
        menu.clear()
        menuInflater.inflate(R.menu.edit_note_menu, menu) // Düzgün menyu faylını burada yükləyin.
    }
