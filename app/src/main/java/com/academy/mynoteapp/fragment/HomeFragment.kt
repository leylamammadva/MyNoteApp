...
import com.academy.mynoteapp.adapter.NoteAdapter
...
class HomeFragment : Fragment(R.layout.fragment_home), SearchView.OnQueryTextListener, MenuProvider {
    ...
    override fun onCreateMenu(menu: Menu, menuInflater: MenuInflater) { //Fragmentdə menyu yaratmaq
    ...
    override fun onMenuItemSelected(menuItem: MenuItem): Boolean { //menuya daxil olduqda
        return false
    }
